        ...
        try:
            while True:
                ...
                try:
                    ...
                    # if((statement.find("епик гамес")!=-1) or (statement.find("епикгеймс")!=-1) or (statement.find("епик геймс")!=-1) or (statement.find("epic games")!=-1) or (statement.find("epic game")!=-1)):
                    #     self.osrun('Epic Games Launcher')
